...
class blu_f {
	...
	//Rifle
    #define WEST_RIFLE "hlc_smg_mp5a2"
    #define WEST_RIFLE_MAG "hlc_30Rnd_9x19_GD_MP5:10"
    
	//GL Rifle
    #define WEST_GLRIFLE "hlc_rifle_Colt727"
    #define WEST_GLRIFLE_MAG "30Rnd_556x45_Stanag:10"
    #define WEST_GLRIFLE_MAG_SMOKE ""
    #define WEST_GLRIFLE_MAG_HE ""
    #define WEST_GLRIFLE_MAG_FLARE ""
    
	//Carbine
    #define WEST_CARBINE "hlc_smg_mp5a2"
    #define WEST_CARBINE_MAG "hlc_30Rnd_9x19_GD_MP5:10"
    ...
    // AR
    #define WEST_AR "hlc_smg_mp5a2"
    #define WEST_AR_MAG "hlc_30Rnd_9x19_GD_MP5:10"
    #define WEST_AR_MAG2 ""
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"TRYK_U_B_3CD_Delta_BDU","TRYK_U_B_3CD_Delta_BDUTshirt"};  /// randomized
        vest[] = {"TRYK_V_ArmorVest_Delta2"}; /// randomized
        headgear[] = {"TRYK_H_DELTAHELM_NV"}; /// randomized
        backpack[] = {"TRYK_B_Belt_br"}; /// randomized
        ...
        items[] = {"ACRE_PRC343"};
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","rhsusf_ANPVS_15"};
        attachments[] = {"hlc_muzzle_Tundra"};
    };
    ...
    class B_officer_F: B_Soldier_F {// CO and DC
        ...
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","rhsusf_ANPVS_15","ItemGPS","ACE_Vector"};
        items[] = {"ACE_MapTools","ACRE_PRC148"};
		attachments[] = {"hlc_muzzle_556NATO_KAC","rhsusf_acc_compm4"};
    };
	
    class B_Soldier_SL_F: B_Officer_F {// SL
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","rhsusf_ANPVS_15","ItemGPS","Binocular"};
...
// Vehicle Infantry
    ...
    class B_Helipilot_F {// Pilot
        ...
        backpackItems[] += {"ACE_key_west","ACRE_PRC117F"};
        items[] = {"ACE_fieldDressing:3","ACE_morphine","ACRE_PRC148"};
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","itemGPS","rhsusf_ANPVS_15"};
    };
