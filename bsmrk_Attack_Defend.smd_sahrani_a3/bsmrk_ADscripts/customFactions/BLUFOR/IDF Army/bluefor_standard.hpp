...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_ISR"};  /// randomized
        vest[] = {"MNP_Vest_ISRKahki_1"}; /// randomized
        headgear[] = {"rhs_6b28_green_ess","H_HelmetB_camo"}; /// randomized
    ...
    class B_officer_F: B_Soldier_F {// CO and DC
        ...
        vest[] = {"MNP_Vest_ISRKahki_1"}; /// randomized
        headgear[] = {"rhs_6b28_green_ess"}; /// randomized
