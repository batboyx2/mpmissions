...
class blu_f {
    ...
    #define WEST_AR_MAG "hlc_100Rnd_762x51_B_M60E4:3"
    #define WEST_AR_MAG2 "hlc_100Rnd_762x51_B_M60E4:3"
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"LOP_U_US_Fatigue_03"};  /// randomized
        vest[] = {"V_BandollierB_oli","V_BandollierB_rgr"}; /// randomized
        headgear[] = {"MNP_Helmet_PAGST_OD","MNP_Helmet_PAGST_RO"}; /// randomized
    ...
    class B_Soldier_SL_F: B_Officer_F {// SL
        ...
        backpackItems[] = {"ACE_fieldDressing:4","ACE_morphine"};
    };
