...
class blu_f {
    ...
    #define WEST_RIFLE_MAG "hlc_20rnd_762x51_barrier_G3:8","hlc_20rnd_762x51_T_G3:2"
    
	//GL Rifle
    #define WEST_GLRIFLE "HLC_Rifle_g3ka4_GL"
    #define WEST_GLRIFLE_MAG "hlc_20rnd_762x51_barrier_G3:8","hlc_20rnd_762x51_T_G3:2"
	...
	//Carbine
    #define WEST_CARBINE "rhs_weap_m4a1_grip2"
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_Germany_S","MNP_CombatUniform_Germany"};  /// randomized
        vest[] = {"MNP_Vest_NZ_2","MNP_Vest_NZ_1"}; /// randomized
        headgear[] = {"MNP_Boonie_GER_T","rhsusf_ach_bare_des_headset_ess"}; /// randomized
        ...
        attachments[] = {"optic_MRCO","acc_pointer_IR"};
    };
