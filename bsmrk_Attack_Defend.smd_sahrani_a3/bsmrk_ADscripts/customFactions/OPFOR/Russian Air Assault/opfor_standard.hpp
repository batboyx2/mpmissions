...
class opf_f {
    //Rifle
    #define EAST_RIFLE "rhs_weap_ak74m"
    #define EAST_RIFLE_MAG "rhs_30Rnd_545x39_AK:8","rhs_30Rnd_545x39_AK:2"
    
	//GL Rifle
    #define EAST_GLRIFLE "rhs_weap_ak74m_gp25"
    #define EAST_GLRIFLE_MAG "rhs_30Rnd_545x39_AK:8","rhs_30Rnd_545x39_AK:2"
    #define EAST_GLRIFLE_MAG_SMOKE "rhs_VG40OP_white:4","rhs_VG40OP_green:1","rhs_VG40OP_red:2"
	...
	//Carbine
    #define EAST_CARBINE "rhs_weap_ak74m"
    #define EAST_CARBINE_MAG "rhs_30Rnd_545x39_AK:8","rhs_30Rnd_545x39_AK:2"
    
	// AR
    #define EAST_AR "hlc_rifle_rpk"
    #define EAST_AR_MAG "hlc_75Rnd_762x39_m_rpk:5"
    #define EAST_AR_MAG2 "hlc_75Rnd_762x39_m_rpk:4"
	...
	// Pistol
    #define EAST_PISTOL "rhs_weap_makarov_pmm"
    #define EAST_PISTOL_MAG "rhs_mag_9x18_12_57N181S:4"
...
// Leadership INF and Groupies
    ...
    class O_Soldier_F { // rifleman
        uniform[] = {"MNP_CombatUniform_RO3_Rg"};  /// randomized
        vest[] = {"LOP_V_6B23_6Sh92_OLV"}; /// randomized
        headgear[] = {"LOP_H_SSh68Helmet_OLV"}; /// randomized
        backpack[] = {"rhs_sidor","B_TacticalPack_oli"}; /// randomized
        backpackItems[] = {"ACE_fieldDressing:3","ACE_morphine"};
    ...
    class O_soldier_SL_F: O_Officer_F { // SL
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ACRE_PRC343","ItemGPS","Binocular"};
	...
	class O_medic_F: O_Soldier_F {// Medic
        vest[] = {"LOP_V_6B23_Medic_OLV"}; /// randomized
        weapons[] = {EAST_CARBINE};
        magazines[] = {EAST_CARBINE_MAG,EAST_SMOKE_WHITE};
        backpackItems[] = {"ACE_fieldDressing:31","ACE_epinephrine:8","ACE_bloodIV:2","ACE_morphine:14"};attachments[] = {"rhs_acc_dtk"};
    };
