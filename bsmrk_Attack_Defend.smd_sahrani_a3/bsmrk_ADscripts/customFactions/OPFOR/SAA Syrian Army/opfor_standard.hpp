...
class opf_f {
    //Rifle
    #define EAST_RIFLE "rhs_weap_akms"
    #define EAST_RIFLE_MAG "rhs_30Rnd_762x39mm:8","rhs_30Rnd_762x39mm:2"
    
	//GL Rifle
    #define EAST_GLRIFLE "rhs_weap_akms_gp25"
    #define EAST_GLRIFLE_MAG "rhs_30Rnd_762x39mm:8","rhs_30Rnd_762x39mm:2"
    ...
    #define EAST_CARBINE_MAG "rhs_30Rnd_762x39mm:8","rhs_30Rnd_762x39mm:2"
...
// Leadership INF and Groupies
    ...
    class O_Soldier_F { // rifleman
        uniform[] = {"LOP_U_AFR_Fatigue_04_slv","LOP_U_AFR_Fatigue_04"};  /// randomized
        vest[] = {"V_TacVest_camo","V_TacVest_oli"}; /// randomized
        headgear[] = {"rhs_6b27m_green_ess","rhs_6b27m_green"}; /// randomized
...
// Vehicle Infantry
    ...
    class O_crew_F {// Crew
        ...
        uniform[] = {"rhs_uniform_m88_patchless"};  /// randomized
