...
class blu_f {
	...
	//Rifle
    #define WEST_RIFLE "rhs_weap_m4a1_blockII_grip2_KAC"
    #define WEST_RIFLE_MAG "30Rnd_556x45_Stanag:8","30Rnd_556x45_Stanag_Tracer_Red:2"
    
	//GL Rifle
    #define WEST_GLRIFLE "rhs_weap_m4a1_blockII_grip2_KAC"
	...
	//Carbine
    #define WEST_CARBINE "hlc_rifle_bcmjack"
   ...
   // Pistol
    #define WEST_PISTOL "rhs_weap_M320"
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_NOR_D_B"};  /// randomized
        vest[] = {"MNP_Vest_NOR_D_2"}; /// randomized
        headgear[] = {"rhsusf_ach_bare_tan_headset_ess","MNP_Boonie_NOR_D"}; /// randomized
        ...
        attachments[] = {"rhsusf_acc_eotech_552","acc_pointer_IR"};
    };
