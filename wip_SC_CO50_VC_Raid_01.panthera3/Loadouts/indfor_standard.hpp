...
// Leadership INF and Groupies
    ...
    class I_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_OD_Rg"};  /// randomized
        vest[] = {"V_BandollierB_khk"}; /// randomized
        headgear[] = {"LOP_H_SSh68Helmet_OLV"}; /// randomized
        backpack[] = {"ibr_backpack"}; /// randomized
        backpackItems[] = {"ACE_fieldDressing:2","ACE_earplugs","APERSTripMine_Wire_Mag"};
        weapons[] = {IND_RIFLE}; /// randomized
        launchers[] = {}; /// randomized
        handguns[] = {}; /// randomized
        magazines[] = {IND_RIFLE_MAG,IND_GRENADE,IND_SMOKE_WHITE};
        items[] = {};
        linkedItems[] = {"ItemCompass","ItemWatch"};
        attachments[] = {""};
    };
    ...
    class I_Soldier_SL_F: I_Officer_F {// SL
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ACRE_PRC343","Binocular"};
        items[] = {"ACE_MapTools","ACRE_PRC148", "ACRE_PRC343"};
        backpackItems[] = {"ACE_fieldDressing:4","ACE_morphine","ACE_earplugs"};
    };
...
// Grunt Infantry		
    ...
    class I_Soldier_TL_F: I_Soldier_F {// FTL
        ...
        linkedItems[] += {"Binocular","ACRE_PRC343"};
        backpackItems[] += {"ACE_key_indp"};
        attachments[] = {""};
    };
    ...
    class I_medic_F: I_Soldier_F {// Medic
        ...
        backpackItems[] = {"ACE_fieldDressing:20","ACE_epinephrine:5","ACE_morphine:10","ACE_earplugs"};
    };
